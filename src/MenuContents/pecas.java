...
public class pecas extends javax.swing.JPanel {
    ...
    private PecasRequest pecas_request = new PecasRequest();
    ...
    public boolean preencherTabela(String biCoordenador) {

        boolean msg = false;

        listaPecas = pecas_request.getPecas(biCoordenador);

        if (!listaPecas.isEmpty()) {
            DefaultTableModel model = (DefaultTableModel) jTable3.getModel();
            model.getDataVector().removeAllElements();
            listaPecas.forEach((valor) -> {
