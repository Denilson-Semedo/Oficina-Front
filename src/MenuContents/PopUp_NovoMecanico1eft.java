 ...
 * @author Denilson
 */
public class PopUp_NovoMecanico1eft extends javax.swing.JFrame {
    ...
    public Efetivo novoEfetivo(){
        
        dadosEfetivo.setInps(jTextField2.getText());
        dadosEfetivo.setNif(jTextField1.getText());
        dadosEfetivo.setSalario(jSpinner1.getWidth());
        
        return dadosEfetivo;
    }
    
    public PopUp_NovoMecanico1eft(Efetivo efetivo) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel16.setText("Numero de NIF");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
        new PopUp_NovoMecanico2(novoEfetivo()).setVisible(true);    
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopUp_NovoMecanico1eft.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
