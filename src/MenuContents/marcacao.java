...
import HttpRequests.MarcacaoRequest;
...
public class marcacao extends javax.swing.JPanel {
    ...
    private MarcacaoRequest marcacao_request = new MarcacaoRequest();
    private List<Marcacao> listaMarcacao = new ArrayList<>();
    ...
    public boolean preencherTabela() {
        ...
        listaMarcacao = marcacao_request.getMarcacao();

        if (listaMarcacao != null) {
            DefaultTableModel model = (DefaultTableModel) jTable3.getModel();
            model.getDataVector().removeAllElements();
            listaMarcacao.forEach((valor) -> {

                model.addRow(new Object[]{valor.getCliente(),valor.getMatricula(),valor.getData()});
