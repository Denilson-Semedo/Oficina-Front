 ...
 * @author Denilson
 */
public class novoMecanico extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(novoMecanico.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
