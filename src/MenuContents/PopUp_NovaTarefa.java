 ...
 * @author Denilson
 */
public class PopUp_NovaTarefa extends javax.swing.JFrame {

    /**
     * Creates new form TelaManutencao2NovaEntrada
     */
    public PopUp_NovaTarefa() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel17.setText("Selecionar veiculo");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ST-00-AA" }));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PopUp_NovaTarefa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PopUp_NovaTarefa().setVisible(true);
            }
        });
    }
